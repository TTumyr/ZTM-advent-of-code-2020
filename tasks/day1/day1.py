...
def day1():
    ...
    def init():
        numbers = calculate_answer(return_numbers(convert_to_number(string_split(number_txt_string))))
        print("The relevant numbers -- ", numbers[0])
        print("Solution -- two numbers multiplication: ", numbers[1])
        print("Solution -- three numbers multiplication: ", numbers[2])
    init()
